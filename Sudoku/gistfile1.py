...
#   "generador.py". Así mismo este fuente debe nombrarlo 
#   como "sudoku.py". (Todo esto si se ejecuta bajo GNU/Linux, en el caso
#   de que se quiera ejecutar bajo cualquier otra plataforma han de
#   hacerse las modificaciones convenientes).
#       
